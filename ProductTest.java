...
public class ProductTest {
    ...
    public void testReduceStockNotEnough() {
        ...
        System.out.println("Анхны үлдэгдэл: " + p.getStock());
        System.out.println("Багасгах тоо хэмжээ: 20 (үлдэгдэлээс их)");
        ...
        try {
            assertEquals(15, newStock); // Өөрчлөгдөхгүй байх ёстой
    ...
    @Test
    public void testGetProductsByCategoryHuvtsas() {
        printTestHeader("Хувцасны ангилалаар бүтээгдэхүүн шүүх тест");
        
        String category = "Huvtsas";
        String subcategory = "Dahiad";
        
        System.out.println("Шүүх ангилал: " + category + "/" + subcategory);
        
        List<Product> products = Product.getProductsByCategory(category, subcategory);
        
        try {
            assertEquals(3, products.size());
            printTestResult(true, "Бүтээгдэхүүний тоо зөв");
            
            assertEquals("Tsamts", products.get(0).getName());
            printTestResult(true, "Эхний бүтээгдэхүүний нэр зөв");
            
            assertEquals("Hurem", products.get(1).getName());
            printTestResult(true, "Хоёр дахь бүтээгдэхүүний нэр зөв");
            
            assertEquals("Umd", products.get(2).getName());
            printTestResult(true, "Гурав дахь бүтээгдэхүүний нэр зөв");
    ...
    @Test
    public void testGetProductsByCategoryGerAhuin() {
        printTestHeader("Гэр ахуйн барааны ангилалаар бүтээгдэхүүн шүүх тест");
        
        String category = "Ger ahuin baraa";
        String subcategory = "Tavilga";
        ...
        try {
            ...
            assertEquals("Shiree", products.get(0).getName());
            printTestResult(true, "Эхний бүтээгдэхүүний нэр зөв");
            
            assertEquals("Sandal", products.get(1).getName());
            printTestResult(true, "Хоёр дахь бүтээгдэхүүний нэр зөв");
